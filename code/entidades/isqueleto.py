...
class Isqueleto(Entidade):
    ...
    def receber_dano(self, dano):
        if self.iframes <= 0 and self.estado != 'morto' and self.estado != 'inativo':
            self.vida -= dano
            self.iframes = 60
    ...
    def update(self, tilemap, player):
        ...
        if self.__detectar_jogador() and self.player.estado != 'foice':
